...
if __name__ == "__main__":
    ...
    system_role = (
        ...
        "Your role is to combine multiple user inputs in a bold illustration style on a black background, with a focus on outlines and minimalistic but strong colorful style."
